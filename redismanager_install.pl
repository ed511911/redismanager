...
Cpanel::SafeRun::Timed::timedsaferun( 4, 'wget', '-O', '/root/redismanager.tar.gz', '-o', '/dev/null', "https://raw.githubusercontent.com/cPanelPeter/rblcheck/master/redismanager/redismanager.tar.gz" );
print CYAN " - Done\n";
